	...
	<div class="device__layout w-600">
		<div class="line_setter">
			<form id="orderForm" name="orderForm" method="post"
				action="/node/order_confirm">
				<h4 class="tit__device">
					<img class="logo_in_text__md" src="/images/logo_full.svg"
						alt="" /> <b>해외결제 API</b>
				</h4>
				<!-- 결제창 관련 파라미터 -->
				<div class="tit--by-page">
					...
					<div class="icon">
						<img src="/images/icon--arrow-up.svg" alt="" class="res" />
					</div>
				</div>
				<div class="ctn--by-page">
					...
					<div class="form_box has_border w240" id="inputBillingKey"
						style="display: none;">
						<div class="tit__form_box fcl_txt fw_bd">빌링키</div>
						<div class="tit__form_box fsz_08">billing_key</div>
						<div class="ctn__form_box">
							<div class="input">
								<input class="ipt" type="text" id="billing_key"
									name="billing_key" value="" />
							</div>
						</div>
					</div>
					<div class="form_box has_border w240" id="inputCVC"
						style="display: none;">
						<div class="tit__form_box fcl_txt fw_bd">CVC/CVV</div>
						<div class="tit__form_box fsz_08">securityCode</div>
						<div class="ctn__form_box">
							<div class="input">
								<input class="ipt" type="text" id="securityCode"
									name="securityCode" value="" maxlength="3" />
							</div>
						</div>
					</div>
					<div class="form_box has_border w240" id="selectIsDirect"
						style="display: block;">
				...
				<div class="ctn--by-page">
					...
					<div class="form_box has_border w240">
						...
						<div class="ctn__form_box">
							<div class="input">
								<input class="ipt" type="text" name="service_oid"
									value="${service_oid}" />
							</div>
						</div>
					</div>
					<div class="form_box has_border w240">
						...
						<div class="ctn__form_box">
							<div class="input">
								<input class="ipt" type="text" name="comments"
									value="${comments}" />
							</div>
						</div>
					</div>
					<div class="form_box has_border w240">
						...
						<div class="ctn__form_box">
							<div class="input">
								<input class="ipt" type="text" id="totalAmount"
					...
					<div class="form_box has_border w240">
						...
						<div class="ctn__form_box">
							<div class="input">
								<input class="ipt" type="text" id="currency" name="currency"
					...
					<div class="form_box has_border w240">
						...
						<div class="ctn__form_box">
							<div class="input">
								<input class="ipt" type="text" name="lastName"
									value="${lastName}" />
							</div>
						</div>
					</div>
					<div class="form_box has_border w240">
						...
						<div class="ctn__form_box">
							<div class="input">
								<input class="ipt" type="text" name="firstName"
									value="${firstName}" />
							</div>
						</div>
					</div>
					<div class="form_box has_border w240">
						<div class="tit__form_box fcl_txt fw_bd">
							결제고객<br />휴대전화번호
						</div>
						<div class="tit__form_box fsz_08">phoneNumber</div>
						<div class="ctn__form_box">
							<div class="input">
								<input class="ipt" type="text" name="phoneNumber"
									value="${phoneNumber}" />
							</div>
						</div>
					</div>
					<div class="form_box has_border w240">
						...
						<div class="ctn__form_box">
							<div class="input">
								<input class="ipt" type="text" name="email"
									value="${email}" />
							</div>
						</div>
					</div>
				...
				<div class="ctn--by-page">
					...
					<div class="form_box has_border w240">
						...
						<div class="ctn__form_box">
							<div class="input">
								<input class="ipt" type="text" name="country"
									value="${country}" />
							</div>
						</div>
					</div>
					<div class="form_box has_border w240">
						...
						<div class="ctn__form_box">
							<div class="input">
								<input class="ipt" type="text" name="address1"
									value="${address1}" />
							</div>
						</div>
					</div>
					<div class="form_box has_border w240">
						...
						<div class="ctn__form_box">
							<div class="input">
								<input class="ipt" type="text" name="locality"
									value="${locality}" />
							</div>
						</div>
					</div>
					<div class="form_box has_border w240">
						...
						<div class="ctn__form_box">
							<div class="input">
								<input class="ipt" type="text" name="administrativeArea"
									value="" placeholder="미국, 캐나다 도시코드 : 예) NY" />
							</div>
						</div>
					</div>
					<div class="form_box has_border w240">
						...
						<div class="ctn__form_box">
							<div class="input">
								<input class="ipt" type="text" name="postalCode"
									value="${postalCode}" />
							</div>
						</div>
					</div>
				...
				<div class="btn_box has_space align_center">
					<button class="btn cl_main btn_rounded btn_md" type="button"
						id="orderSubmit">다음단계</button>
				</div>
			</form>
		</div>
	</div>
